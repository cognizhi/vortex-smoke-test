...
- `/api/healthz-smoke-1009679915` — Returns `{ ok: true, variant: "1009679915" }` (SPRINT-0008)
...
# SPRINT-0008: Variant smoke test endpoint (1009679915)
...
This endpoint follows the established pattern from previous variant endpoints (SPRINT-0001 through SPRINT-0007) to maintain consistency and operational familiarity.

### Acceptance Criteria

✅ **Endpoint exists and responds**
- GET `/api/healthz-smoke-1009679915` responds with HTTP 200
- Response body: `{ ok: true, variant: "1009679915" }`
...
- Uses Next.js App Router convention: `src/app/api/healthz-smoke-1009679915/route.ts`
- Variant identifier "1009679915" is hardcoded in the response
...
- Single GET endpoint for variant "1009679915"
...
- Location: `src/app/api/healthz-smoke-1009679915/route.ts`
- Export async `GET` handler function
- Use Next.js `NextResponse.json()` API
- Response structure: `{ ok: true, variant: "1009679915" }`
- Include JSDoc header documenting the endpoint
- No guards, middleware, or conditional logic needed

**Test Coverage**
- Unit test file: `src/app/api/healthz-smoke-1009679915/__tests__/route.test.ts`
- Tests should verify:
  - HTTP 200 status code
  - Exact response body: `{ ok: true, variant: "1009679915" }`
...
|--------|------|-------|--------|------|-------|
| VRTX-0042 | EPIC | Add /healthz-smoke-1009679915 endpoint | — | VST-0008 | Sprint container |
| VRTX-0043 | FEATURE | Implement /healthz-smoke-1009679915 GET endpoint | VRTX-0042 | — | Feature specification |
| VRTX-0044 | TASK | Implement and test /healthz-smoke-1009679915 endpoint | VRTX-0043 | — | Development work |
...
**Added:**
- New variant-specific health check endpoint `/api/healthz-smoke-1009679915`
- Returns `{ ok: true, variant: "1009679915" }` with zero dependencies
...
- Pattern follows established variant endpoint model from SPRINT-0001 through SPRINT-0007
...
**Tickets:**
- VRTX-0042 (EPIC): Add /healthz-smoke-1009679915 endpoint
- VRTX-0043 (FEATURE): Implement /healthz-smoke-1009679915 GET endpoint
- VRTX-0044 (TASK): Implement and test /healthz-smoke-1009679915 endpoint
