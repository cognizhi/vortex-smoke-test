...
- `/api/healthz-smoke-cancel-307882310` — Returns `{ ok: true, variant: "307882310" }` (SPRINT-0021)
...
This endpoint follows the established pattern from previous variant endpoints (SPRINT-0001 through SPRINT-0020) to maintain consistency and operational familiarity.

### Acceptance Criteria

✅ **Endpoint exists and responds**
- GET `/healthz-smoke-cancel-307882310` responds with HTTP 200
- Response body: `{ ok: true, variant: "307882310" }`
...
- Uses Next.js App Router convention: `src/app/api/healthz-smoke-cancel-307882310/route.ts`
- Variant identifier "307882310" is hardcoded in the response
...
- Single GET endpoint for variant "307882310"
...
- **Path:** `GET /healthz-smoke-cancel-307882310`
...
- Location: `src/app/api/healthz-smoke-cancel-307882310/route.ts`
- Export async `GET` handler function
- Use Next.js `NextResponse.json()` API
- Response structure: `{ ok: true, variant: "307882310" }`
- Include JSDoc header documenting the endpoint
- No guards, middleware, or conditional logic needed

**Test Coverage**
- Unit test file: `src/app/api/healthz-smoke-cancel-307882310/__tests__/route.test.ts`
- Tests should verify:
  - HTTP 200 status code
  - Exact response body: `{ ok: true, variant: "307882310" }`
...
|--------|------|-------|--------|------|-------|
| VRTX-0113 | EPIC | Add /healthz-smoke-cancel-307882310 endpoint | — | VST-0016 | Sprint container |
| VRTX-0114 | TASK | Implement /healthz-smoke-cancel-307882310 endpoint handler | VRTX-0113 | — | Development work |
...
### 2026-07-05 — SPRINT-0021: Variant smoke test endpoint (307882310)

**Added:**
- New variant-specific health check endpoint `/healthz-smoke-cancel-307882310`
- Returns `{ ok: true, variant: "307882310" }` with zero dependencies
...
- Pattern follows established variant endpoint model from SPRINT-0001 through SPRINT-0020
