...
- `/api/healthz-smoke-cancel-309388299` — Returns `{ ok: true, variant: "309388299" }` (SPRINT-0019)
...
This endpoint follows the established pattern from previous variant endpoints (SPRINT-0001 through SPRINT-0018) to maintain consistency and operational familiarity.

### Acceptance Criteria

✅ **Endpoint exists and responds**
- GET `/healthz-smoke-cancel-309388299` responds with HTTP 200
- Response body: `{ ok: true, variant: "309388299" }`
...
- Uses Next.js App Router convention: `src/app/api/healthz-smoke-cancel-309388299/route.ts`
- Variant identifier "309388299" is hardcoded in the response
...
- Single GET endpoint for variant "309388299"
...
- **Path:** `GET /healthz-smoke-cancel-309388299`
...
- Location: `src/app/api/healthz-smoke-cancel-309388299/route.ts`
- Export async `GET` handler function
- Use Next.js `NextResponse.json()` API
- Response structure: `{ ok: true, variant: "309388299" }`
- Include JSDoc header documenting the endpoint
- No guards, middleware, or conditional logic needed

**Test Coverage**
- Unit test file: `src/app/api/healthz-smoke-cancel-309388299/__tests__/route.test.ts`
- Tests should verify:
  - HTTP 200 status code
  - Exact response body: `{ ok: true, variant: "309388299" }`
...
|--------|------|-------|--------|------|-------|
| VRTX-0102 | EPIC | Add /healthz-smoke-cancel-309388299 endpoint | — | VST-0014 | Sprint container |
| VRTX-0103 | FEATURE | Implement /healthz-smoke-cancel-309388299 endpoint with variant metadata | VRTX-0102 | — | Feature specification |
| VRTX-0104 | TASK | Implement GET /api/healthz-smoke-cancel-309388299 endpoint | VRTX-0103 | — | Development work |
...
### 2026-07-05 — SPRINT-0019: Variant smoke test endpoint (309388299)

**Added:**
- New variant-specific health check endpoint `/healthz-smoke-cancel-309388299`
- Returns `{ ok: true, variant: "309388299" }` with zero dependencies
...
- Pattern follows established variant endpoint model from SPRINT-0001 through SPRINT-0018
