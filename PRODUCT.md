...
- `/api/healthz-smoke-cancel-223573630` — Returns `{ ok: true, variant: "223573630" }` (SPRINT-0018)
...
This endpoint follows the established pattern from previous variant endpoints (SPRINT-0001 through SPRINT-0017) to maintain consistency and operational familiarity. The `cancel` naming variant extends the smoke test family to support deployment scenarios tied to cancellation-related code paths or infrastructure.

### Acceptance Criteria

✅ **Endpoint exists and responds**
- GET `/healthz-smoke-cancel-223573630` responds with HTTP 200
- Response body: `{ ok: true, variant: "223573630" }`
...
- Uses Next.js App Router convention: `src/app/api/healthz-smoke-cancel-223573630/route.ts`
- Variant identifier "223573630" is hardcoded in the response
...
- Single GET endpoint for variant "223573630"
...
- **Path:** `GET /healthz-smoke-cancel-223573630`
...
- Location: `src/app/api/healthz-smoke-cancel-223573630/route.ts`
...
**Test Coverage**
- Unit test file: `src/app/api/healthz-smoke-cancel-223573630/__tests__/route.test.ts`
- Tests should verify:
  - HTTP 200 status code
  - Exact response body: `{ ok: true, variant: "223573630" }`
...
|--------|------|-------|--------|------|-------|
| VRTX-0097 | EPIC | Add /healthz-smoke-cancel-223573630 endpoint | — | VST-0013 | Sprint container |
| VRTX-0098 | FEATURE | Implement /healthz-smoke-cancel-223573630 GET endpoint | VRTX-0097 | — | Feature specification |
| VRTX-0099 | TASK | Implement and test /healthz-smoke-cancel-223573630 endpoint | VRTX-0098 | — | Development work |
...
### 2026-07-05 — SPRINT-0018: Variant smoke test endpoint (223573630)

**Added:**
- New variant-specific health check endpoint `/healthz-smoke-cancel-223573630`
- Returns `{ ok: true, variant: "223573630" }` with zero dependencies
...
- Supports cancellation-related deployment scenarios and infrastructure verification

**Implementation details:**
- Pattern follows established variant endpoint model from SPRINT-0001 through SPRINT-0017
...
- Named for deployment scenarios emphasizing cancellation code path verification
