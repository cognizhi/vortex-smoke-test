# VRTX-0546 Implementation Plan

**Ticket:** VRTX-0546  
**Defect:** `/healthz-smoke-bugfix-261077566` returns 404, should return {"ok":true,"variant":"261077566"}  
**Sprint:** SPRINT-0094  
...
```bash
curl http://localhost:3000/api/healthz-smoke-bugfix-261077566
# Expected: HTTP 200 with {"ok":true,"variant":"261077566"}
...
```
src/app/api/healthz-smoke-bugfix-261077566/route.ts
```
 ...
 * This endpoint identifies the specific variant build (261077566) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix-261077566
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "261077566" }
 */
...
✅ Verify response body is exactly `{"ok":true,"variant":"261077566"}`  
✅ Verify response Content-Type is `application/json`  
✅ Verify endpoint responds in under 100ms  
✅ Manual repro with `curl http://localhost:3000/api/healthz-smoke-bugfix-261077566`  
...
curl -i http://localhost:3000/api/healthz-smoke-bugfix-261077566
