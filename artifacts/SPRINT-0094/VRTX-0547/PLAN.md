# VRTX-0547 Implementation Plan

**Ticket:** VRTX-0547  
**Defect:** `/healthz-smoke-bugfix2-856253589` returns 404, should return {"ok":true,"variant":"856253589"}  
**Sprint:** SPRINT-0094  
...
```bash
curl http://localhost:3000/api/healthz-smoke-bugfix2-856253589
# Expected: HTTP 200 with {"ok":true,"variant":"856253589"}
...
```
src/app/api/healthz-smoke-bugfix2-856253589/route.ts
```
 ...
 * This endpoint identifies the specific variant build (856253589) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix2-856253589
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "856253589" }
 */
...
✅ Verify response body is exactly `{"ok":true,"variant":"856253589"}`  
✅ Verify response Content-Type is `application/json`  
✅ Verify endpoint responds in under 100ms  
✅ Manual repro with `curl http://localhost:3000/api/healthz-smoke-bugfix2-856253589`  
