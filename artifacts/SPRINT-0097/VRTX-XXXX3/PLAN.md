# VRTX-XXXX3 Plan: Implement Endpoint C (`/healthz-smoke-661868846-c`)

**TASK:** Implement the third independent health check variant endpoint
...
Implement the GET endpoint `/api/healthz-smoke-661868846-c` that returns `{ ok: true, variant: "661868846" }` with HTTP 200. This endpoint is **fully standalone** — no shared code with endpoints A or B, no dependencies, no database access.
...
**Implementation:**
- Single route file: `src/app/api/healthz-smoke-661868846-c/route.ts`
...
**Testing:**
- Unit test file: `src/app/api/healthz-smoke-661868846-c/__tests__/route.test.ts`
...
- Zero dependencies on TASK-1 or TASK-2
...
**Route:** `/api/healthz-smoke-661868846-c`  
**Method:** GET  
...
- [ ] Create directory `src/app/api/healthz-smoke-661868846-c/`
...
Pattern from previous sprints (509572604-c, 53261999-c, etc.):
...
- SPRINT-0093 (929192825-c) — Three independent endpoints
- SPRINT-0092 (509572604-c) — Three independent endpoints with E2E tests
- SPRINT-0088 (53261999-c) — Three independent endpoints
- SPRINT-0073 (121996100-c) — Pattern established
- SPRINT-0070 (1012136249-c), SPRINT-0069 (276127630-c), and earlier variants

**References:**
- Implementation reference: `/src/app/api/healthz-smoke-509572604-c/route.ts`
- Test reference: `/src/app/api/healthz-smoke-509572604-c/__tests__/route.test.ts`
...
- [ ] Endpoint is registered at `/api/healthz-smoke-661868846-c`
...
1. **No Shared Code:** This endpoint must have zero code reuse with VRTX-XXXX1 or VRTX-XXXX2. Each is a completely independent module.
