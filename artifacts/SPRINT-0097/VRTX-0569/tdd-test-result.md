# TDD Test Result: VRTX-0569

**Endpoint:** `GET /api/healthz-smoke-661868846-c`  
**Test File:** `src/app/api/healthz-smoke-661868846-c/__tests__/route.test.ts`  
**Date:** 2026-07-21
...
1. **Returns 200 with correct JSON**
   - Creates NextRequest to `/api/healthz-smoke-661868846-c`
   - Calls GET handler with the request
   - Asserts response status is 200
   - Asserts response body equals `{ ok: true, variant: '661868846' }`
...
$ npm run test -- run src/app/api/healthz-smoke-661868846-c/__tests__/route.test.ts
 ...
 ✓ src/app/api/healthz-smoke-661868846-c/__tests__/route.test.ts (3 tests) 6ms
