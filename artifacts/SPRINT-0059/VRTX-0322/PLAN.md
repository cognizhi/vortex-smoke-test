...
Implement the first independent health check endpoint for variant 778162394. This endpoint is completely self-contained with no dependencies on other endpoints or shared code.

## Scope

**Deliverables:**
1. Route handler: `/src/app/api/healthz-smoke-778162394-a/route.ts`
2. Test suite: `/src/app/api/healthz-smoke-778162394-a/__tests__/route.test.ts`
...
**File:** `/src/app/api/healthz-smoke-778162394-a/route.ts`
**Size:** ~8 lines
...
describe('GET /api/healthz-smoke-778162394-a', () => {
...
**This TASK owns:**
- `/src/app/api/healthz-smoke-778162394-a/route.ts` — GET handler
- `/src/app/api/healthz-smoke-778162394-a/__tests__/route.test.ts` — Test suite
...
1. **Current variant (same sprint):** None yet (this is the first 778162394 endpoint)
...
1. Delete `/src/app/api/healthz-smoke-778162394-a/` directory
