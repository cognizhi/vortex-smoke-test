/**
 * GET /api/healthz-smoke-962270004
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (962270004) in the response.
 *
 ...
 *
 * Response body:
 *   { "data": { "ok": true, "variant": "962270004" }, "error": null }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-962270004
 *
 ...
 *
 * @returns NextResponse with status 200 and body { data: { ok: true, variant: "962270004" }, error: null }
 */
