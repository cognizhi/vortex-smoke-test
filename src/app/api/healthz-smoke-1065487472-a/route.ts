/**
 * GET /api/healthz-smoke-1065487472-a
 *
...
/**
 * GET handler for /api/healthz-smoke-1065487472-a
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "1065487472" }
 */
