 ...
 * This endpoint identifies the specific variant build (691130485) in the response.
 *
 ...
 *
 * Response body:
 *   { "ok": true, "variant": "691130485" }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-bugfix2-691130485
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "691130485" }
 */
