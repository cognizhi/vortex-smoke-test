 ...
 * This endpoint identifies the specific variant build (454075717) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix-ha2-454075717
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "454075717" }
 */
