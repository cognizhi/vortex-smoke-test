 ...
 * This endpoint identifies the specific variant build (688707801) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-688707801
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "688707801" }
 */
