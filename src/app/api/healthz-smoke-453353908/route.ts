/**
 * GET /api/healthz-smoke-453353908
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (453353908) in the response.
 *
 ...
 *
 * Response body:
 *   { "ok": true, "variant": "453353908" }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-453353908
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "453353908" }
 */
