 ...
 * to verify this specific application variant (800427409) is deployed and reachable.
 *
...
/**
 * GET handler for /api/healthz-smoke-800427409
 *
 ...
 * The variant identifier "800427409" is hardcoded, enabling deployment verification
 * in distributed environments where multiple application variants may be deployed.
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "800427409" }
 */
