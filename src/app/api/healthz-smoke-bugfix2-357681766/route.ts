 ...
 * This endpoint identifies the specific variant build (357681766) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix2-357681766
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "357681766" }
 */
