 ...
 * This endpoint identifies the specific variant build (110428092) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-110428092
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "110428092" }
 */
