/**
 * GET /api/healthz-smoke-bugfix-630670662
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (630670662) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix-630670662
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "630670662" }
 */
