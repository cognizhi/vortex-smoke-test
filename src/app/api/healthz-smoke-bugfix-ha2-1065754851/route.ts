 ...
 * This endpoint identifies the specific variant build (ha2-1065754851) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix-ha2-1065754851
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "1065754851" }
 */
