/**
 * GET /api/healthz-smoke-bugfix-ha2-489393049
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (ha2-489393049) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix-ha2-489393049
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "ha2-489393049" }
 */
export async function GET(): Promise<NextResponse> {
  return NextResponse.json(
    {
      ok: true,
      variant: 'ha2-489393049',
    },
    { status: 200 }
  );
}
