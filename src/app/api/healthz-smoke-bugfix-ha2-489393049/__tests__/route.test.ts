...
describe('GET /api/healthz-smoke-bugfix-ha2-633156065', () => {
  ...
  describe('Response Status and Body', () => {
    ...
    it('RH-02: returns valid JSON with exact response body', async () => {
      ...
      expect(json).toEqual({ ok: true, variant: '633156065' });
    });
    ...
    it('RH-05: variant field is string "633156065"', async () => {
      const response = await GET();
      const json = await response.json();
      expect(json.variant).toBe('633156065');
