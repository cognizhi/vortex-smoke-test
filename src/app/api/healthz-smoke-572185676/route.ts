 ...
 *
 * This endpoint includes a variant identifier (572185676) to distinguish between
 ...
 *
 * Response body:
 *   { "ok": true, "variant": "572185676" }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-572185676
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "572185676" }
 */
