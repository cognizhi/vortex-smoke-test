 ...
 * This endpoint identifies the specific variant build (449792264) in the response.
 *
 ...
 *
 * Response body:
 *   { "ok": true, "variant": "449792264" }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-bugfix-449792264
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "449792264" }
 */
