 ...
 * to verify this specific application variant (197298697) is deployed and reachable.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix-ha-197298697
 *
 ...
 * The variant identifier "197298697" is hardcoded, enabling deployment verification
 * in distributed environments where multiple application variants may be deployed.
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "197298697" }
 */
