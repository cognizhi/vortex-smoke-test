/**
 * Comprehensive test suite for GET /api/healthz-smoke-737151464-a
 *
...
describe('GET /api/healthz-smoke-737151464-a', () => {
  beforeEach(() => {
  ...
  describe('Suite 1: Response Status and Body', () => {
    ...
    it('RH-02: returns valid JSON with exact response body', async () => {
      ...
      expect(json).toEqual({ ok: true, variant: '737151464' });
    });
  ...
  describe('Suite 3: Consistency', () => {
    ...
    it('RH-07: multiple calls return identical responses', async () => {
      ...
      const expected = { ok: true, variant: '737151464' };
