...
describe('GET /api/healthz-smoke-519443986', () => {
  ...
  describe('Response Status and Body', () => {
    ...
    it('RH-02: returns valid JSON with exact response body', async () => {
      ...
      expect(json).toEqual({ ok: true, variant: '519443986' });
    });
    ...
    it('RH-05: variant field is string "519443986"', async () => {
      const response = await GET();
      const json = await response.json();
      expect(json.variant).toBe('519443986');
