/**
 * Comprehensive test suite for GET /api/healthz-smoke-1012136249-b
 *
 * Variant-specific lightweight health check endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (1012136249) in the response.
 *
 * Test coverage:
...
describe("GET /api/healthz-smoke-1012136249-b", () => {
  ...
  describe("Suite 1: Response Status and Body", () => {
    ...
    it("RH-02: returns valid JSON with exact response body", async () => {
      ...
      expect(json).toEqual({ ok: true, variant: "1012136249" });
    });
  ...
  describe("Suite 3: Consistency", () => {
    ...
    it("RH-07: multiple calls return identical responses", async () => {
      ...
      const expected = { ok: true, variant: "1012136249" };
