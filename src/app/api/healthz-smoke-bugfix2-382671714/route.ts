/**
 * GET /api/healthz-smoke-bugfix2-382671714
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (382671714) in the response.
 *
 ...
 *
 * Response body:
 *   { "ok": true, "variant": "382671714" }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-bugfix2-382671714
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "382671714" }
 */
