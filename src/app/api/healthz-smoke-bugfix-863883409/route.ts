 ...
 * This endpoint identifies the specific variant build (863883409) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix-863883409
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "863883409" }
 */
