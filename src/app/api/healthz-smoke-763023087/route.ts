/**
 * GET /api/healthz-smoke-763023087
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (763023087) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-763023087
 *
 ...
 *
 * @returns NextResponse with status 200 and body { data: { ok: true, variant: "763023087" }, error: null }
 */
