...
describe('GET /api/healthz-smoke-bugfix2-712753350', () => {
  ...
  describe('Response Status and Body', () => {
    ...
    it('RH-02: returns valid JSON with exact response body', async () => {
      ...
      expect(json).toEqual({ ok: true, variant: '712753350' });
    });
    ...
    it('RH-05: variant field is string "712753350"', async () => {
      const response = await GET();
      const json = await response.json();
      expect(json.variant).toBe('712753350');
