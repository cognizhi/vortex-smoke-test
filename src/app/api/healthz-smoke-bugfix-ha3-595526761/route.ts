 ...
 * This endpoint identifies the specific variant build (ha3-595526761) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix-ha3-595526761
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "595526761" }
 */
