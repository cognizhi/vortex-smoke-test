/**
 * GET /api/healthz-smoke-bugfix3-739668299
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (smoke-bugfix3-739668299) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix3-739668299
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "739668299" }
 */
