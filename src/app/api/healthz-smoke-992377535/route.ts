 ...
 * This endpoint identifies the specific variant build (992377535) in the response.
 *
 ...
 *
 * Response body:
 *   { "data": { "ok": true, "variant": "992377535" }, "error": null }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-992377535
 *
 ...
 *
 * @returns NextResponse with status 200 and body { data: { ok: true, variant: "992377535" }, error: null }
 */
