 ...
 *
 * Response body:
 *   { "ok": true, "variant": "1052557025" }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-bugfix2-1052557025
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "1052557025" }
 */
