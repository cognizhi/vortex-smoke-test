 ...
 * This endpoint identifies the specific variant build (96685) in the response.
 *
 ...
 *
 * Response body:
 *   { "data": { "ok": true, "variant": "96685" }, "error": null }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-96685
 *
 ...
 *
 * @returns NextResponse with status 200 and body { data: { ok: true, variant: "96685" }, error: null }
 */
