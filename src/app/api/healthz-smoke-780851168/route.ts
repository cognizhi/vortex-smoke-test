/**
 * GET /api/healthz-smoke-780851168
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (780851168) in the response.
 *
 ...
 *
 * Response body:
 *   { "ok": true, "variant": "780851168" }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-780851168
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "780851168" }
 */
