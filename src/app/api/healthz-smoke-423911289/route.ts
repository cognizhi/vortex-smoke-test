/**
 * GET /api/healthz-smoke-423911289
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (423911289) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-423911289
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "423911289" }
 */
