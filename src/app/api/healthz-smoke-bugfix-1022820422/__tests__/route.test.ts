...
describe('GET /api/healthz-smoke-bugfix-1022820422', () => {
  ...
  describe('Response Status and Body', () => {
    ...
    it('RH-02: returns valid JSON with exact response body', async () => {
      ...
      expect(json).toEqual({ ok: true, variant: '1022820422' });
    });
    ...
    it('RH-05: variant field is string "1022820422"', async () => {
      const response = await GET();
      const json = await response.json();
      expect(json.variant).toBe('1022820422');
