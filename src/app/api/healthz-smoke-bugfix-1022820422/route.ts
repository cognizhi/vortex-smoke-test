/**
 * GET /api/healthz-smoke-bugfix-1022820422
 *
 ...
 * to verify this specific application variant (1022820422) is deployed and reachable.
 *
 ...
 *
 * Response body:
 *   { "ok": true, "variant": "1022820422" }
 */

import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-bugfix-1022820422
 *
 ...
 * The variant identifier "1022820422" is hardcoded, enabling deployment verification
 * in distributed environments where multiple application variants may be deployed.
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "1022820422" }
 */
