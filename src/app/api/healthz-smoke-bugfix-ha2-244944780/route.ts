 ...
 * This endpoint identifies the specific variant build (ha2-244944780) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix-ha2-244944780
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "244944780" }
 */
