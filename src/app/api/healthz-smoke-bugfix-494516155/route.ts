 ...
 * This endpoint identifies the specific variant build (494516155) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix-494516155
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "494516155" }
 */
