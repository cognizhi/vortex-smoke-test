/**
 * GET /api/healthz-smoke-bugfix2-407985318
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (407985318) in the response.
 *
 ...
 *
 * Response body:
 *   { "ok": true, "variant": "407985318" }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-bugfix2-407985318
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "407985318" }
 */
