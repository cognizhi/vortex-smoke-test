 ...
 * This endpoint identifies the specific variant build (901947994) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-901947994
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "901947994" }
 */
