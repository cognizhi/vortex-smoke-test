 ...
 * to verify this specific application variant (609817388) is deployed and reachable.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix-ha-609817388
 *
 ...
 * The variant identifier "609817388" is hardcoded, enabling deployment verification
 * in distributed environments where multiple application variants may be deployed.
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "609817388" }
 */
