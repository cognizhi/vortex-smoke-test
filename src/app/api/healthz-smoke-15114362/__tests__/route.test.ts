/**
 * Unit tests for GET /api/healthz-smoke-15114362
 *
 * Variant health check endpoint for load balancers and monitoring systems.
 * This variant build is identified by the code 15114362.
 *
 * Tests verify:
 *   - Returns 200 status code
 *   - Correct JSON response shape { ok: true, variant: "15114362" }
...
describe('GET /api/healthz-smoke-15114362', () => {
  beforeEach(() => {
  ...
  // AC-03: Response body matches spec: { ok: true, variant: "15114362" }
  ...
  // AC-05: ok field is boolean true (not just truthy string/number)
  ...
  // AC-06: variant field is string "15114362" (not number)
  it('RH-06: variant field is string "15114362" (not number)', async () => {
    const res = await GET();
