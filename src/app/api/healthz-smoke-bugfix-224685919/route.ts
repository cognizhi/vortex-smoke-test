 ...
 * This endpoint identifies the specific variant build (224685919) in the response.
 *
 ...
 *
 * Response body:
 *   { "ok": true, "variant": "224685919" }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-bugfix-224685919
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "224685919" }
 */
