 ...
 * This endpoint identifies the specific variant build (963602537) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-963602537
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "963602537" }
 */
