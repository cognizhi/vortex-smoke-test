/**
 * GET /api/healthz-smoke-bugfix-254027906
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (254027906) in the response.
 *
 ...
 *
 * Response body:
 *   { "ok": true, "variant": "254027906" }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-bugfix-254027906
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "254027906" }
 */
