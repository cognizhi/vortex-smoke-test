/**
 * GET /api/healthz-smoke-bugfix2-813098132
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (bugfix2-813098132) in the response.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix2-813098132
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "813098132" }
 */
