/**
 * GET /api/healthz-smoke-bugfix-432732268
 *
 * Variant-specific lightweight smoke test endpoint for load balancers and monitoring systems.
 * This endpoint identifies the specific variant build (432732268) in the response.
 *
 ...
 *
 * Response body:
 *   { "ok": true, "variant": "432732268" }
 */
import { NextResponse } from 'next/server';

/**
 * GET handler for /api/healthz-smoke-bugfix-432732268
 *
 ...
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "432732268" }
 */
