...
/**
 * GET handler for /api/healthz-smoke-bugfix-ha-28079633
 *
 ...
 * The variant identifier "28079633" is hardcoded, enabling deployment verification
 * in distributed environments where multiple application variants may be deployed.
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "28079633" }
 */
