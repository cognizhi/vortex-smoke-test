/**
 * Unit tests for GET /api/healthz-smoke-971125744-c
 *
 * Smoke test endpoint variant for load balancers and monitoring systems.
 * Tests verify:
 *   - Returns 200 status code
 *   - Correct JSON response shape { ok: true, variant: "971125744" }
...
describe('GET /api/healthz-smoke-971125744-c', () => {
  beforeEach(() => {
  ...
  // AC-02: Response body matches spec: { ok: true, variant: "971125744" }
