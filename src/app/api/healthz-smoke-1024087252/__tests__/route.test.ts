...
describe('GET /api/healthz-smoke-1024087252', () => {
  ...
  // AC-03: Response body matches spec: { ok: true, variant: "1024087252" }
  ...
  // AC-06: variant field is string "1024087252" (not number)
  it('RH-06: variant field is string "1024087252" (not number)', async () => {
    const res = await GET();
