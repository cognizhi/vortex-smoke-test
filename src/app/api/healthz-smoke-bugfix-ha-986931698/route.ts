 ...
 * to verify this specific application variant (ha-986931698) is deployed and reachable.
 *
...
/**
 * GET handler for /api/healthz-smoke-bugfix-ha-986931698
 *
 ...
 * The variant identifier "ha-986931698" is hardcoded, enabling deployment verification
 * in distributed environments where multiple application variants may be deployed.
 *
 * @returns NextResponse with status 200 and body { ok: true, variant: "ha-986931698" }
 */
