/**
 * Comprehensive test suite for GET /api/healthz-smoke-637917955-b
 *
...
describe('GET /api/healthz-smoke-637917955-b', () => {
  ...
  describe('Suite 1: Response Status and Body', () => {
    ...
    it('RH-02: returns valid JSON with exact response body', async () => {
      ...
      expect(json).toEqual({ ok: true, variant: '637917955' });
    });
  ...
  describe('Suite 3: Consistency', () => {
    ...
    it('RH-07: multiple calls return identical responses', async () => {
      ...
      const expected = { ok: true, variant: '637917955' };
