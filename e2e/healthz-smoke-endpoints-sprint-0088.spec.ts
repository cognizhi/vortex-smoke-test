...
test.describe('Healthz smoke endpoints — SPRINT-0088 (53261999)', () => {
  test('GET /api/healthz-smoke-53261999-a returns 200 with ok and variant', async ({
    request,
  }) => {
  ...
  test('GET /api/healthz-smoke-53261999-b returns 200 with ok and variant', async ({
    request,
  }) => {
  ...
  test('GET /api/healthz-smoke-53261999-c returns 200 with ok and variant', async ({
    request,
  }) => {
  ...
  test('all three endpoints respond with correct content-type', async ({
    ...
    const endpoints = [
      '/api/healthz-smoke-53261999-a',
      '/api/healthz-smoke-53261999-b',
      '/api/healthz-smoke-53261999-c',
    ]
