...
- **`/api/healthz-smoke-{variant}`** (SPRINT-0005+) — Variant-specific health check
  ...
  variants: `498421836` (SPRINT-0020), `305070125` (SPRINT-0015), `110428092` (SPRINT-0013), `48842051` (SPRINT-0009),
...
**Added:**
- Variant-specific health check endpoint `/api/healthz-smoke-cancel-498421836` for deployment
  verification and monitoring. Returns `{ ok: true, variant: "498421836" }` with zero
...
- Implemented as separate route file (`/api/healthz-smoke-cancel-498421836/route.ts`).
