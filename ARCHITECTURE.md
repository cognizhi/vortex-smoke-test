...
- **`/api/healthz-smoke-{variant}`** (SPRINT-0005+) — Variant-specific health check
  ...
  variants: `15114362` (SPRINT-0036), `688707801` (SPRINT-0034), `572185676` (SPRINT-0029), `901947994` (SPRINT-0027), `305070125` (SPRINT-0015), `110428092` (SPRINT-0013),
...
**Added:**
- Variant-specific health check endpoint `/healthz-smoke-15114362` for deployment
  verification and monitoring. Returns `{ ok: true, variant: "15114362" }` with zero
...
- Implemented as separate route file (`/api/healthz-smoke-15114362/route.ts`).
