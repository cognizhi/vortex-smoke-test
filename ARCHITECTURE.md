...
- **`/api/healthz-smoke-{variant}`** (SPRINT-0005+) — Variant-specific health check
  ...
  variants: `223573630` (SPRINT-0018), `305070125` (SPRINT-0015), `110428092` (SPRINT-0013),
...
**Added:**
- Variant-specific health check endpoint `/healthz-smoke-cancel-223573630` for deployment
  verification and monitoring. Returns `{ ok: true, variant: "223573630" }` with zero
...
- Implemented as separate route file (`/api/healthz-smoke-cancel-223573630/route.ts`).
