...
- **`/api/healthz-smoke-{variant}`** (SPRINT-0005+) — Variant-specific health check
  ...
  variants: `892262901` (SPRINT-0025), `305070125` (SPRINT-0015), `110428092` (SPRINT-0013),
...
**Added:**
- Variant-specific health check endpoint `/api/healthz-smoke-cancel-892262901` for deployment
  verification and monitoring. Returns `{ ok: true, variant: "892262901" }` with zero
...
- Implemented as separate route file (`/api/healthz-smoke-cancel-892262901/route.ts`).
