...
- **`/api/healthz-smoke-{variant}`** (SPRINT-0005+) — Variant-specific health check
  ...
  variants: `679608109` (SPRINT-0031), `572185676` (SPRINT-0029), `901947994` (SPRINT-0027), `305070125` (SPRINT-0015), `110428092` (SPRINT-0013),
...
- Variant-specific health check endpoint `/api/healthz-smoke-cancel-679608109` for deployment
  verification and monitoring. Returns `{ ok: true, variant: "679608109" }` with zero
