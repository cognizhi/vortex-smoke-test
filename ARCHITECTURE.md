...
- Implemented as three separate route files (`/api/healthz-smoke-107173471-{a,b,c}/route.ts`)
- Hardcoded variant identifier `107173471` enables deployment verification without dynamic configuration
