...
- **`/api/healthz-smoke-{variant}`** (SPRINT-0005+) — Variant-specific health check
  ...
  variants: `307882310` (SPRINT-0021), `305070125` (SPRINT-0015), `110428092` (SPRINT-0013), 
...
**Added:**
- Variant-specific health check endpoint `/api/healthz-smoke-cancel-307882310` for deployment
  verification and monitoring. Returns `{ ok: true, variant: "307882310" }` with zero
...
- Implemented as separate route file (`/api/healthz-smoke-cancel-307882310/route.ts`).
